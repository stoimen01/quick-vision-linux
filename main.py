...
flags = tf.app.flags
flags.DEFINE_integer("input_size", 64, "The size of the input images [256]")
flags.DEFINE_integer("target_size", 256, "The size of image to use (will be center cropped) [1024]")

flags.DEFINE_integer("epoch", 20, "Epoch to train [3]")
flags.DEFINE_float("learning_rate", 0.0003, "Learning rate of for adam [0.0002]")
...
flags.DEFINE_string("checkpoint_dir", "checkpoints/outlook_64-256", "Directory name to save or load the checkpoint [checkpoint]")
flags.DEFINE_string("samples_dir", "samples/sample256", "Directory name to save the image samples [samples]")
